...
const ROBOT_HIT_LIMIT = [ 3, 2, 1, 0, 0 ];
...
exports.turnStart = function(force){
	...
	my.game.roundTime = Math.min(my.game.roundTime, Math.max(10000, 1500000 - my.game.chain.length * 1500));
...
exports.submit = function(client, text){
	...
	DB.kkutu[l].findOne([ '_id', text ], (l == "ko") ? [ 'type', Const.KOR_GROUP ] : (l == "en") ? [ '_id', Const.ENG_ID ] : [ '_id', Const.ENG_ID ]).on(onDB);
};
