...
*/
	'EKT': { lang: "en",
		rule: "Classic",
		opts: [ "man", "ext", "mis", "rtu", "olb", "nol", "nog" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
	...
	'ESH': { lang: "en",
		rule: "Classic",
		opts: [ "ext", "mis", "rank", "rtu", "olb", "nol", "nog" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
	...
	'KKT': { lang: "ko",
		rule: "Classic",
		opts: [ "man", /*"safe",*/ "ext", "mis", "loa", "str", "k32", "rank", "rtu", "olb", "nol", "nog" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
	...
	'KSH': { lang: "ko",
		rule: "Classic",
		opts: [ "man", /*"safe",*/ "ext", "mis", "loa", "str", "rank", "rtu", "olb", "nol", "nog" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
	...
	'KAP': { lang: "ko",
		rule: "Classic",
		opts: [ "man", /*"safe",*/ "ext", "mis", "loa", "str", "rtu", "olb", "nol", "nog" ],
		time: 1,
		ai: true,
		big: false,
		_back: true,
	...
	'HUN': { lang: "ko",
		rule: "Hunmin",
		opts: [ "ext", "mis", "loa", "str", "rtu", "olb", "nol", "nog" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
	...
	'KDA': { lang: "ko",
		rule: "Daneo",
		opts: [ "ijp", "mis", "rank", "rtu", "olb", "nol", "nog" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
...
exports.KO_INJEONG = [
	...
	"HSS", /* "KMV", */ "HDC", "HOS",
	/* Dead by Deadlight */ "DBD", /* 파워 쿵쿵따 */ "PKT",
	/* 해외 철도역 */ "TRN", /* 버스 정류장 */ "BUS",
	/* 학교 */ "SCL", /* 영화 */ "KMV",
	/* 웹툰 */ "WBT", /* 자격ㆍ면허 */ "LIC",
	/* 동방 프로젝트  "ZUN",*/ /* PC 게임 */ "PGM",
	/* 콘솔 게임 */ "CGM", /* 쿠키런 */ "CKR",
	/* 알파끄투 */ "APK"
];
exports.EN_INJEONG = [
